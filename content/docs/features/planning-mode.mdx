...
| **Slack `/buildd`** | The [Slack](/docs/features/slack) slash command files its request as a planning task. |
| **Discord `/buildd`** | The [Discord](/docs/features/discord) slash command does the same. |
