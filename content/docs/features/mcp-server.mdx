...
| `manage_objectives` | `action, objectiveId?, title?, status?, skillSlugs?, recipeId?, model?` | Manage team objectives (list/create/get/update/delete/link_task/unlink_task) |
