...
| `manage_heartbeat` | `action, checklist?, workspaceId?` | Get or set workspace heartbeat checklist |
| `create_heartbeat` | `cronExpression?, name?, workspaceId?` | Create a recurring heartbeat schedule |
